...
def login_screen():
    ...
    button_with_image = """
            <button class="gsi-material-button" onclick="st.login;" style="background-color: rgba(128, 128, 128, 0.5); border: none; border-radius: 8px; padding: 10px; cursor: pointer; display: flex; align-items: center; gap: 8px;">
